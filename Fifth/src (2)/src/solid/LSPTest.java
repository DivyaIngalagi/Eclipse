...
//		  Employee jack = new Employee(190, 100);
//		  System.out.printf("Jack's income = %.2f",
//		  jack.getNetIncome());
//		 
//		  Employee jill = new SalesPerson(190, 100, 100000);
//		  System.out.printf("Jill's income = %.2f ",
//		  jill.getNetIncome());
...
//		System.out.printf("Total sales = %.2f%n", totalSales(employees));
		...
		Employee jack = new Employee(190,100);
		jack.getHours();
		Employee jackk = new SalesPerson(190,100,100000);
		SalesPerson sp = (SalesPerson) jackk;
		System.out.println(sp.getSales());
		
//		Employee jack = new SalesPerson(190,100,100000);
//		jack.getHours();
//		SalesPerson sp = (SalesPerson) jack;
//		sp.getSales();
