...
public class CheckStringTest {
	...
	class TruncateACharacterFromString
	{
		...
		//@Disabled
		@Tag("A_AT1postion")
		public void testTruncateAtFirstAnd2Position_2ndCondition() {
			assertEquals("CD", checkstring.TruncateAtFirstAnd2Position("ABCD"));
		...
		@Tag("NoAChar")
		public void testTruncateAtFirstAnd2Position_ThirdCondition() {
